...
public class Rational implements Cloneable, Comparable<Rational>
{
        ...
        * @author Richard J. Mathar
        */
        public Rational(java.util.Vector<BigInteger> cfr)
        {
                if ( cfr.size() == 0)
                ...
                else
                {
                        ...
                        */
                        java.util.Vector<BigInteger> clond = new java.util.Vector<BigInteger>() ;
        ...
        * @author Richard J. Mathar
        */
        public java.util.Vector<BigInteger> cfrac()
        {
                if ( signum() < 0 )
                        throw new NumberFormatException("Unsupported cfrac for negative "+this) ;
                java.util.Vector<BigInteger> cf = new Vector<BigInteger>() ;
                if ( signum() != 0)
                {
