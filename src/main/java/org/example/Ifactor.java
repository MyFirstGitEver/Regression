...
public class Ifactor implements Cloneable, Comparable<Ifactor>
{
        ...
        */
        public java.util.Vector<Integer> primeexp ;
        ...
        */
        public Ifactor(int number)
        {
                ...
                primeexp = new java.util.Vector<Integer>() ;
                if( number > 1 )
                {
                        int primindx = 0 ;
        ...
        * @author Richard J. Mathar
        */
        public Ifactor(java.util.Vector<Integer> pows)
        {
                primeexp = new java.util.Vector<Integer>(2* pows.size()) ;
                if ( pows.size() > 0 )
                {
                        n = BigInteger.ONE ;
                        Prime primes = new Prime() ;
        ...
        */
        ...
        {
                java.util.Vector<Integer> p = (java.util.Vector<Integer>)primeexp.clone();
        ...
        * @author Richard J. Mathar
        */
        public java.util.Vector<BigInteger> divisors()
        {
                ...
                */
                java.util.Vector<BigInteger> d=new java.util.Vector<BigInteger>() ;
                ...
                if ( n.compareTo(BigInteger.ONE) > 0 )
                {
                        ...
                        java.util.Vector<BigInteger> partd = dp.divisors() ;
        ...
        * @author Richard J. Mathar
        */
        public static Ifactor max(final java.util.Vector<Ifactor> set)
        {
